...
//     - Sessions are used to store information (in the form of variables) that can be used throughout multiple pages. The function stated creates a session or resumes the current one based on session identifiers. 
